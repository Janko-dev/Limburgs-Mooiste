        ...
        <Modal animationType='slide' visible={isVisible}>
            <View style={styles.container}>
                ...
                <Animated.View style={[transformStepThree, styles.animViewContainer]}>
                    <Text style={[globalStyles.headerText, styles.headerText]}>Vraag 3: dit is een multiselect component </Text>
                    <MultiOptionPicker
                ...
                <Animated.View style={[transformStepFour, styles.animViewContainer]}>
                    <Text style={[globalStyles.headerText, styles.headerText]}>Klaar!! </Text>
