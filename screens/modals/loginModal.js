            ...
            <View style={styles.container}>
                ...
                <Animated.View style={[transformStepOne, styles.animationContainer]}>
                    ...
                    <View style={styles.bodyContainer}>
                        <Text style={[globalStyles.bodyText, styles.headerText]}>Welkom bij de Limburgs Mooiste Trainingsapp</Text>
                    ...
                    <KeyboardAvoidingView behavior='padding' style={styles.formContainer}>
                        <Text style={[globalStyles.bodyText, styles.headerText, { marginBottom: 15 }]}>Voer inloggegevens in</Text>
                        <Input
